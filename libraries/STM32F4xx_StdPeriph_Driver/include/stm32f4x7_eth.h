...
#define MAX_ETH_PAYLOAD         256    /*!< Maximum Ethernet payload size */
#define JUMBO_FRAME_PAYLOAD    9000    /*!< Jumbo frame payload size */      
#define ETH_MAX_PACKET_SIZE    (ETH_HEADER + ETH_EXTRA + VLAN_TAG + MAX_ETH_PAYLOAD + ETH_CRC)
...
#ifndef ETH_RXBUFNB
 #define ETH_RXBUFNB             5     /*  Rx buffers of size ETH_RX_BUF_SIZE */
#endif
...
#define IS_ETH_PHY_ADDRESS(ADDRESS) ((ADDRESS) <= 198)
